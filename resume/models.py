...
class Resume(TrackerMixin):
    ...
    skills = ArrayField(base_field=models.CharField(max_length=128, blank=False, null=False))
    work_experiences = ArrayField(base_field=models.CharField(max_length=128, blank=False, null=False))
